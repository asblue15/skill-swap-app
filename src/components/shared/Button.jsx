...
export default function Button({content, navigateLink}) {
  const navigate = useNavigate()

  return (
    <button 
      onClick={() => {navigate(navigateLink)} } 
      className="custom-button relative group border-none bg-transparent p-0 outline-none cursor-pointer font-mono font-light uppercase text-base">
